...
/**
 * DO NOT ADD FSM IN THIS CLASS!!!!!!!11111!!11!!!1!!
 * To add any new FSM, create it in the class that will use it, not in here.
 * 
 * You should, however, change the necessary enums, that is the Transition enum or the StateID enum, in this class
 * 
 * 
 * 
 * 
